...
/**
 * DRAFT → PENDING_APPROVAL → APPROVED → FUNDING_PENDING → SUBMITTED_TO_PROVIDER
...
export const PAYOUT_TRANSITIONS: TransitionMap<PayoutStatus> = Object.freeze({
  ...
  APPROVED: ["FUNDING_PENDING", "SUBMITTED_TO_PROVIDER", "CANCELLED", "MANUAL_REVIEW", "FAILED"],
  FUNDING_PENDING: ["SUBMITTED_TO_PROVIDER", "FAILED", "MANUAL_REVIEW", "CANCELLED"],
  SUBMITTED_TO_PROVIDER: ["PROCESSING", "COMPLETED", "FAILED", "MANUAL_REVIEW"],
...
export const TRADER_TRANSITIONS: TransitionMap<TraderStatus> = Object.freeze({
  ...
  KYC_APPROVED: ["PROVIDER_ACCOUNT_PENDING", "ACCOUNT_RESTRICTED"],
  PROVIDER_ACCOUNT_PENDING: ["PROVIDER_ACCOUNT_ACTIVE", "PROVIDER_ERROR", "MANUAL_REVIEW"],
  PROVIDER_ACCOUNT_ACTIVE: ["CARD_ELIGIBLE", "ACCOUNT_RESTRICTED"],
  ...
  ACCOUNT_RESTRICTED: [],
  CARD_INELIGIBLE: [],
  PROVIDER_ERROR: ["MANUAL_REVIEW", "KYC_PENDING", "PROVIDER_ACCOUNT_PENDING", "VIRTUAL_CARD_PENDING"],
  MANUAL_REVIEW: [
    "KYC_PENDING",
    "KYC_APPROVED",
    "KYC_REJECTED",
...
export function traderCanReceivePayout(status: TraderStatus): boolean {
  return (
    status === "PROVIDER_ACCOUNT_ACTIVE" ||
